...
const API_URL = window.API_URL || ((/localhost|127\.0\.0\.1|192\.168\.|::1/.test(window.location.hostname)) ? `${DEFAULT_BASE_URL}/api` : 'https://eventhub-api-649702844549.us-central1.run.app/api');
